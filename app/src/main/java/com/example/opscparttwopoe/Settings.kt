...
class Settings : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.opscparttwopoe.R.layout.settings)
        MinGoals = findViewById(com.example.opscparttwopoe.R.id.MinGoals)
        MaxGoals = findViewById(com.example.opscparttwopoe.R.id.MaxGoals)
        Language = findViewById(com.example.opscparttwopoe.R.id.Language)
        Mode = findViewById(com.example.opscparttwopoe.R.id.Mode)
        ChangePassword = findViewById(com.example.opscparttwopoe.R.id.ChangePassword)
        ChangeUsername = findViewById(com.example.opscparttwopoe.R.id.ChangeUsername)
        savebtn = findViewById(com.example.opscparttwopoe.R.id.Savebtn)
